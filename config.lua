...
Config.AdministrationStations = {

	Administration = {

		Blip = {
			Coords  = vector3(-914.35, -2039.46, 9.4),
			Sprite  = 439,
			Display = 4,
			Scale   = 0.7,
			Colour  = 46
		...
		Cloakrooms = {
			vector3(-938.05, -2036.58, 9.4)
		},

		Armories = {
			vector3(-918.56, -2037.21, 16.09)
		},

		BossActions = {
			vector3(-928.86, -2026.24, 16.05)
		}
...
Config.AuthorizedWeapons = {
	recruit = {
		{weapon = 'WEAPON_SNSPISTOL', price = 12000},
	},
	...
	lieutenant = {
		{weapon = 'WEAPON_COMBATPISTOL', price = 12000},	
	},
...
Config.CustomPeds = {
	shared = {
		{label = 'Administration', maleModel = 's_m_y_cop_01', femaleModel = 's_f_y_cop_01'},
		{label = 'AdministrationBLK', maleModel = 's_m_y_ranger_01', femaleModel = 's_m_y_ranger_01'},
		{label = 'AdministrationWTE', maleModel = 's_m_y_barman_01', femaleModel = 's_m_y_barman_01'},
